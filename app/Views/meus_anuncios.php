    ...
    <body>
        <main>
            <section class="right-container">
                ...
                $query_veiculos = (
                    "SELECT id, marca, modelo, cor, ano, motor, placa, valor, data_anuncio, foto_1, status
                        FROM veiculos
                ...
                ?>
                                    ...
                                    <div class="options-content">
                                        ...
                                        <div class="admin-icon">
                                            ...
                                            <div class="bin">
                                                ...
                                                <button type="submit" name="apagar" value="<?php echo $id ?>"><img src="img/lixeira.svg" /></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    ?>
                    <h2>Você ainda não possui nenhum anúncio.</h2>
                <?php
                }
                ?>
            </section>
